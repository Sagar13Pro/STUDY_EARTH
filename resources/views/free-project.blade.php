...
<!-- Mirrored from axilthemes.com/demo/template/keystroke/single-service.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Mar 2021 04:00:04 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
        ...
        <div class="main-wrapper">
            ...
            <div class="axil-working-process-area ax-section-gap theme-gradient-4">
                                ...
                                <div class="content">
                                    <div class="inner">
                                        <div class="section-title">
                                            ...
                                            <pre class="subtitle-2">{{ $item->projectContent }}</pre>
                ...
                {{-- <div class="axil-working-process mb--100 mb_md--50 mb_sm--40">
                                <div class="thumbnail">
                                    <div class="image paralax-image">
                                        <img src="{{ asset('assets/images/process/process-03.jpg') }}" alt="Process Images">
    ...
    {{-- <div class="axil-working-process text-left mb--100 mb_md--50 mb_sm--40">
                                ...
                                <div class="thumbnail order-1 order-lg-2">
                                    <div class="image paralax-image">
                                        <img src="{{ asset('assets/images/process/process-04.jpg') }}" alt="Process Images">
                ...
                <div class="col-lg-12">
                    <div class="mesonry-list grid-metro3 mt--20">
                        ...
                        <div class="portfolio portfolio_style--1 axil-control active portfolio-33-33">
                            <div class="inner move-up wow">
                                <div class="thumb paralax-image">
                                    <a href="single-case-study.html"><img src="{{ asset('assets/images/portfolio/portfolio-01.jpg') }}" alt="Portfolio Images"></a>
                        ...
                        <div class="portfolio portfolio_style--1 axil-control portfolio-33-33">
                            <div class="inner move-up wow">
                                <div class="thumb paralax-image">
                                    <a href="single-case-study.html"><img src="{{ asset('assets/images/portfolio/portfolio-02.jpg') }}" alt="Portfolio Images"></a>
                        ...
                        <div class="portfolio portfolio_style--1 portfolio-33-33">
                            <div class="inner move-up wow">
                                <div class="thumb paralax-image">
                                    <a href="single-case-study.html"><img src="{{ asset('assets/images/portfolio/portfolio-03.jpg') }}" alt="Portfolio Images"></a>
                        ...
                        <div class="portfolio portfolio_style--1 portfolio-33-33">
                            <div class="inner move-up wow">
                                <div class="thumb paralax-image">
                                    <a href="single-case-study.html"><img src="{{ asset('assets/images/portfolio/portfolio-04.jpg') }}" alt="Portfolio Images"></a>
                        ...
                        <div class="portfolio portfolio_style--1 portfolio-33-33">
                            <div class="inner move-up wow">
                                <div class="thumb paralax-image">
                                    <a href="single-case-study.html"><img src="{{ asset('assets/images/portfolio/portfolio-05.jpg') }}" alt="Portfolio Images"></a>
                    ...
                    <div class="view-all-portfolio-button mt--60 text-center move-up wow">
                        <a class="axil-button btn-large btn-transparent" href="#"><span class="button-text">Discover
...
<!-- Mirrored from axilthemes.com/demo/template/keystroke/single-service.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Mar 2021 04:00:06 GMT -->
</html>
